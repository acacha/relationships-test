                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('givenName') }">
                            ...
                            <input type="text" class="form-control" id="givenName" placeholder="Name" name="givenName"
                                   :value="form.givenName" @keyup.stop="updateField('givenName', $event.target.value)" :disabled="isLoading" @change="updateFullName">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('surname1') }">
                            ...
                            <input type="text" class="form-control" id="surname1" placeholder="Surname 1" name="surname1"
                                   :value="form.surname1" @keyup.stop="updateField('surname1', $event.target.value)" :disabled="isLoading" @change="updateFullName">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('surname2') }">
                            ...
                            <input type="text" class="form-control" id="surname2" placeholder="Surname 2" name="surname2"
                                   :value="form.surname2" @keyup.stop="updateField('surname2', $event.target.value)" :disabled="isLoading" @change="updateFullName">
                        </div>
                    </div>
                    <div class="col-md-2">
                        TODO gender
...
//        this.clearing = false
      ...
      submit () {
        //TODO Not always POST, use method instead!!
        //        let API_URL = this.apiURL()
//        let method = this.getMethod()
        this.$store.dispatch('post').then( response => {
          // do stuff
          console.log('HEY!!!!!!!!!!!!!!')
